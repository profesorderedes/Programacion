...
public class AppLucas {
	...
	private static final String NOMBRE_ARCHIVO = "src/agenda/Contactos.txt";
...
// Aquí es donde escribimos los datos del nuevo contacto en Contactos.txt:
			guardarContacto();
	...
	private static void guardarContacto() {
		...
		try {
			...
			buffer.write(apellidos + "," + nombre + "," + tel + "\n");
