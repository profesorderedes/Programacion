...
public class Pruebas {
	...
	public static void crearLibros(Biblioteca biblioteca) {
        ...
        Libro libro1 = new Libro("Grandes esperanzas",
                autores2, "Alfaguara", 2000);
        Libro libro2 = new Libro("Canción de Navidad",
                autores2, "Alfaguara", 1995);
        Libro libro3 = new Libro("Casa negra",
                autores3, "Alianza", 1997);
        Libro libro4 = new Libro("Mar cruel",
                autores4, "Alianza", 1997);
        Libro libro5 = new Libro("Head first Java",
                autores5, "O'Reilly", 2005);
