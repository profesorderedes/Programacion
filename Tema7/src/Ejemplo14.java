...
public class Ejemplo14 extends JFrame {
	...
	public Ejemplo14() {
		...
		String[] comidas = { "Pizza Margarita", "Pizza Cuatro estaciones", "Pizza Carbonara", "Wok de verdura",
				"Macarrones Boloñesa", "Calzone Barbacoa", "Spaghetti al Pesto", "Big Mac", "Ñoqis", "Durum" };
