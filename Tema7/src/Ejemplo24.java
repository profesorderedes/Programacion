...
public class Ejemplo24 extends JFrame implements ItemListener {
	...
	public Ejemplo24() {
		...
		String canciones[] = { "Te boté Remix", "Purpurina", "Amorfoda", "Suavemente", "Gasolina" };
	...
	public void itemStateChanged(ItemEvent e) {
		...
		String autores[] = { "Flow La Movie", "Alberto Gambino", "Bad Bunny", "Childish Gambino", "Daddy Yankee" };
