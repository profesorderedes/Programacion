...
public class BorradoRecursivo {
	...
	private static void borrar(File archivo) {
		...
		// Caso recursivo.
		// El método archivo.isDirectory() devuelve true si el objeto es una // carpeta.
		if (archivo.isDirectory()) {
			// El método archivo.listFiles() devuelve un array de objetos File // que
			// representan los archivos y carpetas contenidos en archivo.
