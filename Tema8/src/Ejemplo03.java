...
public class Ejemplo03 {
	...
	public static void main(String[] args) {
		...
		libros.add(new Libro("Las recetas de Arguiñano", "Karlos Arguiñano"));
		...
		libros.add(new Libro("El lazarillo de Tormes", "Anónimo"));

		// Queremos borrar el libro de Arguiñano.
		Libro libroKarlos = new Libro("Las recetas de Arguiñano", "Karlos Arguiñano");
